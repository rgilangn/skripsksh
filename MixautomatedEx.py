...
def mainTopo():
    ...
    net.addLink(Cl1, Ro1, bw=10)
    net.addLink(Se2, Ro1, bw=1) #, max_queue_size = maxQ
    ...
    Se2.cmd('iperf -s &')
    # Se2.cmd('iperf -s  > dataResult/examine-X/'+str(ccName)+'_'+str(maxQ)+'_mix_LL_iperf-server.txt &')
    ...
    os.system('mv dataResult/examine-X/_LL_iperfRests.txt dataResult/examine-X/'+str(ccName)+'_'+str(maxQ)+'mix_LL_iperfRests.txt')
    os.system('mv dataResult/examine-X/_LL_rttRests.txt dataResult/examine-X/'+str(ccName)+'_'+str(maxQ)+'_mix_LL_rttRests.txt')
    print('=========================================================================')
