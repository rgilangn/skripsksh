...
def mainTopo():
    ...
    Ro1.cmd("ip addr add 192.168.10.1/24 brd + dev Router1-eth6")
    Ro1.cmd("ip addr add 192.168.20.1/24 brd + dev Router1-eth7")
    ...
    # Se2.cmd('iperf -s &')
    Se1.cmd('iperf -s  > dataResult/examine5-6hosts/'+str(ccName)+'_'+str(maxQ)+'_'+str(BW)+'_'+str(hs_size)+'_LL_iperf-server1.txt &')
    Se2.cmd('iperf -s  > dataResult/examine5-6hosts/'+str(ccName)+'_'+str(maxQ)+'_'+str(BW)+'_'+str(hs_size)+'_LL_iperf-server2.txt &')
    Se3.cmd('iperf -s  > dataResult/examine5-6hosts/'+str(ccName)+'_'+str(maxQ)+'_'+str(BW)+'_'+str(hs_size)+'_LL_iperf-server3.txt &')
    Se4.cmd('iperf -s  > dataResult/examine5-6hosts/'+str(ccName)+'_'+str(maxQ)+'_'+str(BW)+'_'+str(hs_size)+'_LL_iperf-server4.txt &')
    Se5.cmd('iperf -s  > dataResult/examine5-6hosts/'+str(ccName)+'_'+str(maxQ)+'_'+str(BW)+'_'+str(hs_size)+'_LL_iperf-server5.txt &')
    Se6.cmd('iperf -s  > dataResult/examine5-6hosts/'+str(ccName)+'_'+str(maxQ)+'_'+str(BW)+'_'+str(hs_size)+'_LL_iperf-server6.txt &')
    # Se7.cmd('iperf -s  > dataResult/examine5-6hosts/'+str(ccName)+'_'+str(maxQ)+'_'+str(BW)+'_LL_iperf-server7.txt &')
    # Se8.cmd('iperf -s  > dataResult/examine5-6hosts/'+str(ccName)+'_'+str(maxQ)+'_'+str(BW)+'_LL_iperf-server8.txt &')
    ...
    Cl1.cmd('iperf -c 192.168.10.2 -t 30 -i 1 > dataResult/examine5-6hosts/1_LL_iperfRests.txt &') #30s
    Cl1.cmd('ping 192.168.10.2 -c 30 > dataResult/examine5-6hosts/1_LL_rttRests.txt & ') #30s
    # Cl1.cmd('ping 192.168.10.2 -c 9 ')

    Cl2.cmd('tcpdump -G 35 -W 1 -w /home/reghn/Documents/pcapngs/2_LL_.pcapng -i Cl2-eth0 &') #62s
    Cl2.cmd('iperf -c 192.168.20.2 -t 30 -i 1 > dataResult/examine5-6hosts/2_LL_iperfRests.txt &') #30s
    Cl2.cmd('ping 192.168.20.2 -c 30 > dataResult/examine5-6hosts/2_LL_rttRests.txt & ') #30s
    # Cl2.cmd('ping 192.168.20.2 -c 9 ')
    
    Cl3.cmd('tcpdump -G 35 -W 1 -w /home/reghn/Documents/pcapngs/3_LL_.pcapng -i Cl3-eth0 &') #62s
    Cl3.cmd('iperf -c 192.168.30.2 -t 30 -i 1 > dataResult/examine5-6hosts/3_LL_iperfRests.txt &') #30s
    Cl3.cmd('ping 192.168.30.2 -c 30 > dataResult/examine5-6hosts/3_LL_rttRests.txt & ') #30s
    # Cl3.cmd('ping 192.168.30.2 -c 9 ')
    
    Cl4.cmd('tcpdump -G 35 -W 1 -w /home/reghn/Documents/pcapngs/4_LL_.pcapng -i Cl4-eth0 &') #62s
    Cl4.cmd('iperf -c 192.168.40.2 -t 30 -i 1 > dataResult/examine5-6hosts/4_LL_iperfRests.txt &') #30s
    Cl4.cmd('ping 192.168.40.2 -c 30 > dataResult/examine5-6hosts/4_LL_rttRests.txt & ') #30s
    # Cl4.cmd('ping 192.168.40.2 -c 9 ')
        
    Cl5.cmd('tcpdump -G 35 -W 1 -w /home/reghn/Documents/pcapngs/5_LL_.pcapng -i Cl5-eth0 &') #62s
    Cl5.cmd('iperf -c 192.168.50.2 -t 30 -i 1 > dataResult/examine5-6hosts/5_LL_iperfRests.txt &') #30s
    Cl5.cmd('ping 192.168.50.2 -c 30 > dataResult/examine5-6hosts/5_LL_rttRests.txt & ') #30s
    # Cl5.cmd('ping 192.168.50.2 -c 9 ')

    Cl6.cmd('tcpdump -G 35 -W 1 -w /home/reghn/Documents/pcapngs/6_LL_.pcapng -i Cl6-eth0 &') #62s
    Cl6.cmd('iperf -c 192.168.60.2 -t 30 -i 1 > dataResult/examine5-6hosts/6_LL_iperfRests.txt &') #30s
    Cl6.cmd('ping 192.168.60.2 -c 30 > dataResult/examine5-6hosts/6_LL_rttRests.txt & ') #30s
    # Cl6.cmd('ping 192.168.60.2 -c 9 ')
            
    # # Cl7.cmd('tcpdump -G 35 -W 1 -w /home/reghn/Documents/pcapngs/7_LL_.pcapng -i Cl7-eth0 &') #62s
    # Cl7.cmd('iperf -c 192.168.70.2 -t 30 -i 1 > dataResult/examine5-6hosts/7_LL_iperfRests.txt &') #30s
    # Cl7.cmd('ping 192.168.70.2 -c 30 > dataResult/examine5-6hosts/7_LL_rttRests.txt & ') #30s
    # Cl7.cmd('ping 192.168.70.2 -c 9 ')
            
    # # Cl8.cmd('tcpdump -G 35 -W 1 -w /home/reghn/Documents/pcapngs/8_LL_.pcapng -i Cl8-eth0 &') #62s
    # Cl8.cmd('iperf -c 192.168.80.2 -t 30 -i 1 > dataResult/examine5-6hosts/8_LL_iperfRests.txt &') #30s
    # Cl8.cmd('ping 192.168.80.2 -c 30 > dataResult/examine5-6hosts/8_LL_rttRests.txt & ') #30s
    ...
    os.system('mv dataResult/examine5-6hosts/1_LL_iperfRests.txt dataResult/examine5-6hosts/'+str(ccName)+'_'+str(maxQ)+'_'+str(BW)+'_'+str(hs_size)+'_LL_iperfRests_Cl1.txt')
    os.system('mv dataResult/examine5-6hosts/1_LL_rttRests.txt dataResult/examine5-6hosts/'+str(ccName)+'_'+str(maxQ)+'_'+str(BW)+'_'+str(hs_size)+'_LL_rttRests._Cl1.txt')
    ...
    os.system('mv dataResult/examine5-6hosts/2_LL_iperfRests.txt dataResult/examine5-6hosts/'+str(ccName)+'_'+str(maxQ)+'_'+str(BW)+'_'+str(hs_size)+'_LL_iperfRests_Cl2.txt')
    os.system('mv dataResult/examine5-6hosts/2_LL_rttRests.txt dataResult/examine5-6hosts/'+str(ccName)+'_'+str(maxQ)+'_'+str(BW)+'_'+str(hs_size)+'_LL_rttRests._Cl2.txt')
    ...
    os.system('mv dataResult/examine5-6hosts/3_LL_iperfRests.txt dataResult/examine5-6hosts/'+str(ccName)+'_'+str(maxQ)+'_'+str(BW)+'_'+str(hs_size)+'_LL_iperfRests_Cl3.txt')
    os.system('mv dataResult/examine5-6hosts/3_LL_rttRests.txt dataResult/examine5-6hosts/'+str(ccName)+'_'+str(maxQ)+'_'+str(BW)+'_'+str(hs_size)+'_LL_rttRests._Cl3.txt')
    ...
    os.system('mv dataResult/examine5-6hosts/4_LL_iperfRests.txt dataResult/examine5-6hosts/'+str(ccName)+'_'+str(maxQ)+'_'+str(BW)+'_'+str(hs_size)+'_LL_iperfRests_Cl4.txt')
    os.system('mv dataResult/examine5-6hosts/4_LL_rttRests.txt dataResult/examine5-6hosts/'+str(ccName)+'_'+str(maxQ)+'_'+str(BW)+'_'+str(hs_size)+'_LL_rttRests._Cl4.txt')
    ...
    os.system('mv dataResult/examine5-6hosts/5_LL_iperfRests.txt dataResult/examine5-6hosts/'+str(ccName)+'_'+str(maxQ)+'_'+str(BW)+'_'+str(hs_size)+'_LL_iperfRests_Cl5.txt')
    os.system('mv dataResult/examine5-6hosts/5_LL_rttRests.txt dataResult/examine5-6hosts/'+str(ccName)+'_'+str(maxQ)+'_'+str(BW)+'_'+str(hs_size)+'_LL_rttRests._Cl5.txt')
    ...
    os.system('mv dataResult/examine5-6hosts/6_LL_iperfRests.txt dataResult/examine5-6hosts/'+str(ccName)+'_'+str(maxQ)+'_'+str(BW)+'_'+str(hs_size)+'_LL_iperfRests_Cl6.txt')
    os.system('mv dataResult/examine5-6hosts/6_LL_rttRests.txt dataResult/examine5-6hosts/'+str(ccName)+'_'+str(maxQ)+'_'+str(BW)+'_'+str(hs_size)+'_LL_rttRests._Cl6.txt')
    ...
    # os.system('mv dataResult/examine5-6hosts/7_LL_iperfRests.txt dataResult/examine5-6hosts/'+str(ccName)+'_'+str(maxQ)+'_'+str(BW)+'_LL_iperfRests_Cl7.txt')
    # os.system('mv dataResult/examine5-6hosts/7_LL_rttRests.txt dataResult/examine5-6hosts/'+str(ccName)+'_'+str(maxQ)+'_'+str(BW)+'_LL_rttRests._Cl7.txt')
    ...
    # os.system('mv dataResult/examine5-6hosts/8_LL_iperfRests.txt dataResult/examine5-6hosts/'+str(ccName)+'_'+str(maxQ)+'_'+str(BW)+'_LL_iperfRests_Cl8.txt')
    # os.system('mv dataResult/examine5-6hosts/8_LL_rttRests.txt dataResult/examine5-6hosts/'+str(ccName)+'_'+str(maxQ)+'_'+str(BW)+'_LL_rttRests._Cl8.txt')
